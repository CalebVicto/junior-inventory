...
<html>
  ...
  <body class="hold-transition <?php echo $skin;?>  sidebar-mini">
				...
				<div class="row">
					...
					<div class="col-xs-3 ">
						<div class="btn-group pull-right">
							...
							<a href="new_credit_note.php" class="btn btn-default"><i class='fa fa-plus'></i> Nuevo</a>
							<?php }?>
	...
	function load(page){
		...
		var parametros = {"action":"ajax","page":page,'query':query,'branch_id':branch_id,'customer_id':customer_id,'per_page':per_page};
		$("#loader").fadeIn('slow');
		$.ajax({
			url:'./ajax/notas_credito_ajax.php',
			data: parametros,
	...
	function per_page(valor){
		...
		function eliminar(id){
			...
			if(confirm('Esta acción  eliminará de forma permanente la nota de crédito \n\n Desea continuar?')){
				...
				var parametros = {"action":"ajax","page":page,"query":query,'branch_id':branch_id,'customer_id':customer_id,"per_page":per_page,"id":id};
	...
	<script>
		function note_print(note_id){
			VentanaCentrada('note-print-pdf-sale.php?id='+note_id,'Nota','','1024','768','true');
		}
	</script>
	</script>
