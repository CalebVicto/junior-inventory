...
<html>
  ...
  <body class="hold-transition <?php echo $skin;?> sidebar-mini">
				...
				<div class="row">
					...
					<div class="col-xs-2 ">
						<div class="btn-group pull-right">
							...
							<button type="button" class="btn btn-default" onclick="print_report();"><i class='fa fa-print'></i> Imprimir</button>
							<?php }?>
	...
	function load(page){
		...
		$("#loader").fadeIn('slow');
		$.ajax({
			url:'./ajax/reporte_stock_min_ajax.php',
			data: parametros,
	...
	<script>
		function print_report(){
			...
			var query=$("#q").val();
			var manufacturer_id=$("#manufacturer_id").val();
			 VentanaCentrada('stock--print-pdf.php?product_code='+product_code+"&query="+query+"&manufacturer_id="+manufacturer_id,'Reporte stock','','1024','768','true');
		}
	</script>
