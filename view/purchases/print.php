        ...
        <div class="row">
          ...
          <div class="col-xs-8">
            <div class="table-responsive">
              <table class="table ">
                <tr>
                  <td style="width:100%" ><strong>SON:</strong> 
