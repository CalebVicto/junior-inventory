...
<html>
  ...
  <body class="hold-transition <?php echo $skin;?>  sidebar-mini">
                    ...
                    <div class="row">
						...
						<div class="col-md-3">
							...
							<select class="form-control" id="apply_to" name="apply_to" disabled>
								...
								?>
								<option value="<?php echo $rw['purchase_id']?>" <?php if ($apply_to==$rw['purchase_id']){echo "selected";}?>><?php echo $rw['purchase_order_number']." | Proveedor: ".$rw['name'];?></option>
								<?php
									}
								?>
							</select>
					...
					<div class="row">
						...
						<div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class='form-control' onchange="currency(this.value);" name="currency_id" id="currency_id" disabled>
												<?php 
	...
	$(function () {
		...
		$(".select2").select2();
		$("#resultados" ).load( "./ajax/agregar_nc_buy.php" );
