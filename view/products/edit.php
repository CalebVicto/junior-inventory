<?php
	...
	if (isset($_GET['id'])){
		...
		$stock_min=$rw_product['stock_min'];
	}
      ...
      <div class="content-wrapper">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
			...
			<div id="load_img">
              <img class=" img-responsive" src="<?php echo 	$image_path;?>" alt="Bussines profile picture" data-toggle="modal" data-target="#myModal" style='cursor:pointer'>
			  </div>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="details">
                  ...
                  <div class="form-group">
					...
					<label for="stock_min" class="col-sm-2 control-label">Stock mínimo</label>

                    <div class="col-sm-4">
                      <input type="text" class='form-control' name="stock_min" id="stock_min" required value="<?php echo $stock_min;?>">
                    </div>
