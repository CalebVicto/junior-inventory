    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
		  <h1><i class='fa fa-edit'></i> Editar orden de servicio</h1>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <select class="form-control select2" data-placeholder="<?php echo $name_customer;?>" name="customer_id" id="customer_id">
					<option value="<?php echo $customer_id;?>"><?php echo $name_customer;?></option>
				  </select>
                </div>
                <div class="form-group">
          ...
          <div class="box box-info">
            ...
            <!-- form start -->
			  ...
			  <div class="row">
				...
				<div class="col-md-2">
                    <label>Fecha</label>
                    <input type="text" class="form-control" name="purchase_date"  value="<?php echo $order_date;?>" disabled="">
				</div>
				<div class="col-md-2">
				...
				<div class="col-md-2">
                    ...
                    <input type="text" class="form-control" name="order_id"  value="<?php echo $order_number;?>" disabled="">
                </div>
               </div> 
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
			  ...
			  <div class="box-tools pull-right">
				...
				<?php if ($status==3){ ?>	
					<button type="button" onclick="orderToInvoice('<?php echo $order_id;?>');" class="btn btn-default btn-box-tool"><i class="fa fa-dollar"></i> Facturar</button>
				<?php }?>
...
<script>
	function orderToInvoice(order_id){
		if (confirm('Realmente desea convetir la orden Nº '+order_id+' en factura?'))
		{
			location.replace("new_sale.php?order_id="+order_id);//Redirecciono al modulo de facturacion
		}
	} 
</script>
