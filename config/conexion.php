<?php
	...
	function get_skin(){
		global $con;
		$query=mysqli_query($con,"select skins.value from business_profile, skins where business_profile.skin_id=skins.id and business_profile.id=1 ");
		$row=mysqli_fetch_array($query);
		return $skin=$row['value'];
	}	
	$skin=get_skin();
