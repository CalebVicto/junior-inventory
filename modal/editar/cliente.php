<?php
	...
	$discount_rate=$rw['discount_rate'];
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="activity2">
                    <div class="form-group">
					  ...
					  <div class="form-group">
                        <label for="tax_number" class="col-sm-3 control-label">RUC</label>
                        <div class="col-sm-9">
					  ...
					  <div class="form-group">
                        <label for="discount_rate" class="col-sm-3 control-label">Descuento (%)</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="discount_rate" name="discount_rate"  value="<?php echo $discount_rate;?>" maxlength="2" pattern="[0-9]{1,2}">
                        </div>
                      </div>
